...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        displayHighScorePosition("Rowan", playerHighScorePosition);

        playerHighScorePosition = calculateHighScorePosition(900);
        displayHighScorePosition("Danica", playerHighScorePosition);

        playerHighScorePosition = calculateHighScorePosition(400);
        displayHighScorePosition("Phoenix", playerHighScorePosition);

        playerHighScorePosition = calculateHighScorePosition(50);
        displayHighScorePosition("Sheik", playerHighScorePosition);
